...
`GUARDIAN_OPERATOR_COMMITMENT` pair to paste into the dashboard config, and a
`["0x…"]` public key to add to the Guardian allowlist. Keep the private key
secret. (Falcon keys generated by the multisig SDK or the
