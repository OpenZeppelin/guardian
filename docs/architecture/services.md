...
background-maintained inventory / vault aggregate behind
`GET /dashboard/stats`
([`stats.rs`](../../crates/server/src/dashboard/stats.rs), see
[DASHBOARD.md — Aggregate stats](../DASHBOARD.md#aggregate-stats)).
