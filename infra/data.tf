...
locals {
  ...
  effective_guardian_canonicalization_max_concurrent_accounts = var.guardian_canonicalization_max_concurrent_accounts != null ? var.guardian_canonicalization_max_concurrent_accounts : 4
