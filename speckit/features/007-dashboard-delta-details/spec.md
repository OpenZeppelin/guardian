...
- **FR-015**: The raw underlying transaction summary is NOT returned by the detail endpoint in v1 (US2 scope decision, 2026-05-25). A future debug/audit feature may add it back as a coordinated wire-contract change.
